import{_ as s,o as n,c as a,V as l}from"./chunks/framework.b1ba171e.js";const m=JSON.parse('{"title":"vue动态路由(传递参数)","description":"","frontmatter":{},"headers":[],"relativePath":"vue/vue-router/vue-router2.md","filePath":"vue/vue-router/vue-router2.md"}'),p={name:"vue/vue-router/vue-router2.md"},e=l(`<h1 id="vue动态路由-传递参数" tabindex="-1">vue动态路由(传递参数) <a class="header-anchor" href="#vue动态路由-传递参数" aria-label="Permalink to &quot;vue动态路由(传递参数)&quot;">​</a></h1><h2 id="传递参数的2种方式" tabindex="-1">传递参数的2种方式 <a class="header-anchor" href="#传递参数的2种方式" aria-label="Permalink to &quot;传递参数的2种方式&quot;">​</a></h2><h2 id="方式一-key-value-key-value" tabindex="-1">方式一： ?key=value&amp;key=value <a class="header-anchor" href="#方式一-key-value-key-value" aria-label="Permalink to &quot;方式一： ?key=value&amp;key=value&quot;">​</a></h2><div class="language-js line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 方式一：</span></span>
